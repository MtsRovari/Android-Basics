...
public class SquareCameraPreview extends SurfaceView {
    ...
    public void setCamera(Camera camera) {
        ...
        if (camera != null) {
            ...
            if (mIsZoomSupported) {
                ...
                Toast.makeText(getContext(), "The activity its on focus 3245364758mode", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN: {
                ...
                Toast.makeText(getContext(), "The activity its on focus 3243564mode", Toast.LENGTH_SHORT).show();
                break;
            }
            case MotionEvent.ACTION_UP: {
                if (mIsFocus && mIsFocusReady) {
                    handleFocus(mCamera.getParameters());
                    Toast.makeText(getContext(), "The activity its on focus mod232143e", Toast.LENGTH_SHORT).show();
                }
                mActivePointerId = INVALID_POINTER_ID;
                Toast.makeText(getContext(), "The activity its on fo32456432cus mode", Toast.LENGTH_SHORT).show();
                break;
            }
            case MotionEvent.ACTION_POINTER_DOWN: {
                mCamera.cancelAutoFocus();
                mIsFocus = false;
                Toast.makeText(getContext(), "The activity its on focus mode4", Toast.LENGTH_SHORT).show();
                break;
            }
            case MotionEvent.ACTION_CANCEL: {
                mActivePointerId = INVALID_POINTER_ID;
                Toast.makeText(getContext(), "The activity its on focus mode43", Toast.LENGTH_SHORT).show();
                break;
            }
        }
        Toast.makeText(getContext(), "The activity its on focus mod2134e", Toast.LENGTH_SHORT).show();
        return true;
    }
    ...
    private void handleFocus(Camera.Parameters params) {
        ...
        Toast.makeText(getContext(), "The activity its on focus mod3e", Toast.LENGTH_SHORT).show();
        List<String> supportedFocusModes = params.getSupportedFocusModes();
        if (supportedFocusModes != null
                && supportedFocusModes.contains(Camera.Parameters.FOCUS_MODE_AUTO)) {
            Toast.makeText(getContext(), "The activity its on focus mode2", Toast.LENGTH_SHORT).show();
            ...
            mCamera.autoFocus(new Camera.AutoFocusCallback() {
                ...
                public void onAutoFocus(boolean success, Camera camera) {
                    ...
                    Toast.makeText(getContext(), "The activity its on focus mode", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void setIsFocusReady(final boolean isFocusReady) {
        ...
        Toast.makeText(getContext(), "The activity its safdgfhdsdfon focus mode", Toast.LENGTH_SHORT).show();
    }
    ...
    private boolean setFocusBound(float x, float y) {
        ...
        Toast.makeText(getContext(), "The activity ite3qrewtrehgwer31s on focus mode", Toast.LENGTH_SHORT).show();
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            Toast.makeText(getContext(), "Auto focus status scale listner", Toast.LENGTH_SHORT).show();
            return true;
        }
    }
}
